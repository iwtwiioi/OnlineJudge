...
void update(const int &l, const int &r, const int &x, const int &key, const int &R) {
	if(l==r) {
		mn[x]=min(key, mn[x]);
		return;
	}
...
const int query(const int &l, const int &r, const int &x, const int &L, const int &R) {
